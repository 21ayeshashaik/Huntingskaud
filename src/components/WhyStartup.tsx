...
export default function ValuesSection() {
  ...
  return (
    <section
      ref={ref}
      className={`py-16 bg-white px-4 sm:px-6 lg:px-12 transition-opacity duration-700 ease-out transform ${
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p
          className={`${dmSans.className} text-[16px] sm:text-[18px] font-normal leading-[1.9] mb-12 text-[#7F7F7F] max-w-3xl mx-auto`}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cards.map((card) => (
            <div
              key={card.title}
              className="flex flex-col bg-[#EEEEEE] rounded-[20px] w-full min-h-[296px] py-8 px-6"
            >
              {/* Icon + Title */}
              <div className="flex flex-col items-start gap-4 mb-4">
                ...
                <h3
                  className={`${montserrat.className} font-semibold text-[16px] sm:text-[18px] text-[#3D3D3D] leading-[1.5]`}
                >
                  {card.title}
                </h3>
              </div>
              ...
              {/* Description */}
              <p
                className={`${dmSans.className} text-[15px] sm:text-[16px] font-normal text-[#7F7F7F] leading-[1.6] text-left flex-grow`}
              >
                {card.text}
              </p>
            </div>
