...
export default function HeroSection() {
 ...
 <div className="mt-6 flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
  ...
  className={`${dmSans.className} w-[180px]  h-[45px] sm:h-[46px] md:h-[47px] lg:h-[48px] xl:h-[50px] 2xl:h-[52px] bg-[#007BFF] text-white rounded-full flex items-center justify-center hover:bg-blue-500 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]`}
>
  Hire Talent
</button>
