...
export default function HireSection() {
  ...
  return (
    <section
      ref={ref}
      className={`flex flex-col md:flex-row items-center justify-between gap-y-8 md:gap-x-8 
      py-12 px-6 sm:px-12 md:px-24 xl:px-32 2xl:px-48 
    ...
    >
      ...
      <div className="md:w-5/12 max-w-full sm:max-w-lg">
        ...
        >
          ...
          solutions tailored to their needs. Whether you&apos;re hiring engineers
          at scale or looking for your next CXO, we have the expertise, speed,
        ...
        <div className="flex items-center group mt-4 gap-0 transition-all duration-700 ease-in-out hover:gap-3">
  <div className="relative overflow-hidden">
    <button
      ...
      className={`${dmSans.className} w-[163px] h-[48px] bg-[#007BFF] text-white rounded-full flex items-center justify-center gap-0 hover:bg-blue-600 transition-all duration-300 hover:shadow-lg`}
    >
      Request Talent
    </button>
  </div>
